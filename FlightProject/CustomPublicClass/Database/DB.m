...
//    char *errorMessage;
//    NSString *createSQL = nil;
//    createSQL = @"create table if not exists Train_Search_History(id integer primary key, startStation text, startStation_code text,  endStation text, endStation_code text);";
//    if(sqlite3_exec(database, [createSQL UTF8String], NULL, NULL, &errorMessage)!=SQLITE_OK)
//    {
//        sqlite3_close(database);
//        NSAssert1(0, @"Error creating table flightquery: %s", errorMessage);
