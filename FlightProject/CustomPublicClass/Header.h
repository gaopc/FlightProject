...
#define CalendarViewWidth ViewWidth //日历视图宽度
...
#define keyAdvertisementImg @"keyAdvertisementImg_ThreeDemain" //存储在UserDefault中的显示广告图片
#define keyMaxFlyNum @"key_MaxFlyNum" //存储在UserDefault中的显示广告图片
...
#define ViewStartY  (IOS7_OR_LATER?20:0)
#define ViewWidth [[UIScreen mainScreen] applicationFrame].size.width //self.view.frame.size.width //self.view.frame.size.width
#define ViewHeight  self.view.frame.size.height - ViewStartY //[[UIScreen mainScreen] applicationFrame].size.height-IOS7_OR_LATER //
#define MyVersion @"4.6"   // 版本名称，用于显示
#define MyVersionCode 29 // 版本号，用于和服务器比较 4.6版本是29
#define DBVersion @"7"  // 3.3期软件版本对应数据库版本是5 、4.5期软件版本对应数据库版本是7
#define AutoLoginOutTime 30

#define WeChatId   @"wx15b45f90fd7492db"//微信支付重新申请  @"wx5d88c6a1289eaf42" //掌上航旅微信id
#define kAppKey         @"2114242333"//掌上航旅微博id
#define kRedirectURI    @"http://www.itkt.com/jsp/phone.jsp"//掌上航旅微博回调url

#define ServiceText @"        系统会在您所关注的航班起飞前，自动查询相同日期、航程、航班上的票价情况，当符合条件的低价票出现，与已购票（扣除退票手续费）差额大于等于100元时，系统会发送短信提示您，您可以通过致电400-6858-999客服中心由客服人员为您重新购买机票，节约的机票款将以畅达币形式充值到您的会员账户中，用于您再次购买机票时抵扣机票款使用。\n友情提示：\n1）	当您使用自动降价服务后，再次申请退票时，退还的票款将以畅达币形式返回到您的账户\n2）	儿童客票不参与自动降价服务                                \n3）	客票状态发生过改变后（改签、升舱）自动退出自动降价服务"

#define NavigationController   [(AppDelegate *)[[UIApplication sharedApplication] delegate] navigationController]

#define UMENG_APPKEY @"50bdbb675270156240000161" // 用于友盟统计

/* 定位失败默认天气取值 上次使用选择的城市 */
#define WeatherSelectCity @"_weatherCity"

/*
 春节活动日期 2015.2.11-2015-3.5
 */
#define activeStartDate @"2015-02-11"
#define activeEndDate @"2015-03-05"
...
#define FontColorFF1515 [UIColor colorWithRed:255/255.0 green:21/255.0 blue:21/255.0 alpha:1]
...
//#define ThreeStagesOtherUrl @"http://192.168.7.106:8080/stsf/mvc/mobile"  //小张娜地址

//#define ThreeStagesOtherUrl @"http://jk3.itkt.com:7070/stsf/mvcGZip/mobile"  // 测试环境用到的激活，注册网址
//#define ThreeStagesUrl @"http://jk3.itkt.com:7070/stsf/mvcGZip/mobile"  //
//#define ThreeStagesHttpsUrl @"http://jk3.itkt.com:7070/stsf/mvcGZip/mobile"  //@"https://jk3.itkt.com:8444/stsf/mvc/mobile"
//#define ThreeStagesHotelUrl @"http://t-hotel.itkt.com.cn:6060/RemoteService_Hotel/mvc/mobile"
//#define ThreeStagesCarUrl  @"http://192.168.101.110:7070/RemoteService_Car/mvc/mobile"//@"http://t-car.itkt.com.cn:7070/RemoteService_Car/mvc/mobile"

////// 试运行环境

//#define ThreeStagesOtherUrl @"http://jk.itkt.com.cn:9393/stsf/mvcGZip/mobile"  // 试运行环境用到的激活，注册网址
//#define ThreeStagesUrl @"http://jk.itkt.com.cn:9393/stsf/mvcGZip/mobile"
//#define ThreeStagesHttpsUrl @"http://jk.itkt.com.cn:9393/stsf/mvcGZip/mobile" //@"https://jk.itkt.com.cn:9443/stsf/mvc/mobile"
//#define ThreeStagesHotelUrl @"http://116.213.73.8:8050/RemoteService_Hotel/mvc/mobile"
//#define ThreeStagesCarUrl  @"http://192.168.101.110:7070/RemoteService_Car/mvc/mobile"//@"http://116.213.73.8:8060/RemoteService_Car/mvc/mobile"

////生产环境

#define ThreeStagesOtherUrl @"http://auth.itkt.com:8080/stsf/mvcGZip/mobile" // 生产环境用到的激活，注册网址
#define ThreeStagesUrl @"http://phone.itkt.com:30088/stsf/mvcGZip/mobile"
#define ThreeStagesHttpsUrl  @"http://phone.itkt.com:30088/stsf/mvcGZip/mobile" //
...
#define ThreeStagesWoyinTrainUrl  @"http://116.213.73.4:8050/train_service"//@"http://192.168.101.110:5500/train_service"//@"http://124.207.105.28:5500/itkt_train/mvc/train"      // 火车票连接地址  //火车票域名连接地址 //


#define channelNo  @"Iphoneap4.6" //@"Iphoneap31"     //后六位日期，可变 测试渠道号：Tphone0012012120501
