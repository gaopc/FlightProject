...
@synthesize _activityUrl, _activityDetailUrl, _activityType, _activityDes;
...
- (void)viewDidLoad
{
    ...
    [webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/activity",ThreeStagesUrl]]]];//@"http://192.168.7.123:8080/ClientActivity/advertDetail.html"
