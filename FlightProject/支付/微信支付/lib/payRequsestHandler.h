...
#define APP_ID          @"wx15b45f90fd7492db"               //APPID
#define APP_SECRET      @"36ddd56adab1f58c823e6e22b2c55b1c" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1234973102"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"1949s1956d1978s1992f2001m2013LCD"
//支付结果回调页面
